...
f[:,63] = 1
print(f)
scipy.io.savemat('f.mat', mdict={'f': f.cpu().numpy()})

#Number of snapshots from solution
record_steps = 20
print(str(N) + ', ' + str(s) + ', ' + str(s) + ', ' + str(record_steps))
#Inputs
a = torch.zeros(N, s, s)
#Solutions
...
scipy.io.savemat('ns_data_N20_256_T20.mat', mdict={'a': a.cpu().numpy(), 'u': u.cpu().numpy(), 't': sol_t.cpu().numpy()})
